...
def create_app():
    ...
    app.config["SQLALCHEMY_DATABASE_URI"] ="postgresql://sportsdatabase_orpt_user:cGGuvoh7Z8N6160NnzOBJiAxiXTuQkAk@dpg-d3vhfbfdiees73f03e20-a.singapore-postgres.render.com/sportsdatabase_orpt"
